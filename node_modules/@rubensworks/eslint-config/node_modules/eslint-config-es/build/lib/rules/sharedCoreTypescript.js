...
exports.createSharedRulesFor = void 0;
const pickRulesFor_1 = require("../pickRulesFor");
const createSharedRulesFor = ({ language }) => {
    ...
    const specialCamelCaseRule = language === 'javascript' ?
        {
            camelcase: [{
                    properties: 'always',
    ...
    return {
        ...
        ...(0, pickRulesFor_1.pickRulesFor)({ language }, {
...
exports.createSharedRulesFor = createSharedRulesFor;

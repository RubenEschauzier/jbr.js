...
const GeneratorFactory_1 = require("../lib/config/GeneratorFactory");
const ResolutionContext_1 = require("../lib/resolution/ResolutionContext");
function showHelp() {
...
if (args.help) {
    ...
    new GeneratorFactory_1.GeneratorFactory({ resolutionContext: new ResolutionContext_1.ResolutionContext() })
...
//# sourceMappingURL=componentsjs-generator.js.map
 ...
 */
const runConfig = function (configPath, properties, constructionSettings) {
 ...
 * @param constructionSettings - Settings for instantiation.
 */
const runCustom = function (args, stdin, stdout, stderr, properties, constructionSettings) {
...
`);
        ...
        return yield (0, exports.runConfig)(configPath, properties, constructionSettings);
    }))().then(() => {
        // Done
    }).catch(error => {

...
export declare class HookSparqlEndpointComunica implements Hook {
    ...
    readonly additionalBinds: string[];
    readonly clientPort: number;
    readonly clientLogLevel: string;
    readonly queryTimeout: number;
    readonly maxMemory: number;
    constructor(dockerfileClient: string, resourceConstraints: DockerResourceConstraints, configClient: string, contextClient: string, additionalBinds: string[], clientPort: number, clientLogLevel: string, queryTimeout: number, maxMemory: number);
